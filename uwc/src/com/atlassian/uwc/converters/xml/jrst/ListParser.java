 ...
 * Lists.
 * 
 * @see com.atlassian.uwc.converters.xml.ListParser
 * @see https://studio.plugins.atlassian.com/wiki/display/UWC/UWC+Xml+Converter+Framework+Examples#UWCXmlConverterFrameworkExamples-ListParser
 * 
...
public class ListParser extends DefaultXmlParser {
	...
	public enum Type {
		...
		static Type getType(String qName) {
			if ("enumerated_list".equals(qName)) return ORDERED;
			if ("bullet_list".equals(qName)) return UNORDERED;
			if ("list_item".equals(qName)) return ITEM;
			return null;
		}
	}
